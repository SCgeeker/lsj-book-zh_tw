...
> [導讀簡報](slides2A.html){target="_blank"}
...
|等距尺度|![](images/variable-continuous.svg)|![](images/variable-ordinal.svg)|
|比例尺度|![](images/variable-continuous.svg)|![](images/variable-ordinal.svg)|
...
> [導讀簡報](slides2B.html){target="_blank"}
...
- **內部一致性信度**。如果一套測量是由許多測量功能類似的量尺組成(例如，由圍繞相同主題的幾個問題加總，所得到的人格問卷結果)，每個部分的測量問題能測得相近的數值。我們將在 @sec-Internal-consistency-reliability-analysis 詳細地學習這種評估信度的方法。  
...
> [導讀簡報](slides2C.html){target="_blank"}

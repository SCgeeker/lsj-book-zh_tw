...
<!--- teaching note: 使用最新的在地民調為例
2023/3/3 TVBS 民調：https://cc.tvbs.com.tw/portal/file/poll_center/2023/20230306/7d5ea012c8e8d9dfe010340672208be7.pdf
2022 台灣九合一選舉人數：https://udn.com/news/story/6656/6783987
--->
...
Once you start thinking about statistics in these terms, that statistics is there to help us draw inferences from data, you start seeing examples of it everywhere. For instance, here's a tiny extract from a newspaper article in the Sydney Morning Herald (30 Oct 2010):[^translation-1]

[^translation-1]: 譯註~在此使用最新的在地政治新聞說明，請參考[TVBS 2023/3/3民調](https://cc.tvbs.com.tw/portal/file/poll_center/2023/20230306/7d5ea012c8e8d9dfe010340672208be7.pdf)以及[2022年台灣九合一選舉人數](https://udn.com/news/story/6656/6783987)。
...
Before we start talking about probability theory, it's helpful to spend a moment thinking about the relationship between probability and statistics. The two disciplines are closely related but they're not identical. Probability theory is "the doctrine of chances". It's a branch of mathematics that tells you how often different kinds of events will happen. For example, all of these questions are things you can answer using probability theory:[^translation-2]

[^translation-2]: 譯註~要用數字回答的問題，需不需要用「機率模型」解決？必須用「機率模型」解決的數字問題，一定是機率問題。<br>要用數字回答的問題，只要找到合理方法排列數字就能解決，只是*描述*統計問題。例如 @sec-Drawing-graphs 一開始談到的1854年倫敦蘇活區霍亂疫情調查。<br>各式各樣的機率分佈，都是「機率模型」。
...
### 機率分佈入門[^translation-6] {#sec-introducing-probability-distributions}
...
[^translation-6]: 這一節建議搭配[seeing theory隨機變數互動網頁](https://seeing-theory.brown.edu/probability-distributions/index.html#section1)一起學習。

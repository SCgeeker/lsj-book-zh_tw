...
使用jamovi計算多元迴歸的程序與簡單迴歸完全一樣。我們要做的就是在jamovi的'自變項'對話框添加更多自變項。像是要使用dani.sleep和baby.sleep作為預測變項來解釋為什麼我如此煩躁，那麼將baby.sleep移動到與dani.sleep相鄰的'協變項'框中。默認情況下，jamovi假設該模型應該包括一個截距。這次我們得到的係數顯示在 @tbl-tab10-4 中。

...
## 中文化版本沿革與版權說明 {.unnumbered}

中文化電子書翻譯及改編自統計學教材~ Navarro DJ and Foxcroft DR (2022). learning statistics with jamovi: a tutorial for psychology students and other beginners. (Version 0.75). [DOI: 10.24384/hgc3-7p15](https://dx.doi.org/10.24384/hgc3-7p15)

中文化電子書採用[姓名標示-相同方式分享 4.0 國際](https://creativecommons.org/licenses/by-sa/4.0/deed.zh-hant)開放授權釋出。任何人得以任何媒介或格式重製及散布本素材，或重混、轉換本素材、及依本素材建立新素材且為任何目的，包含商業性質之使用。只要使用者遵守授權條款規定，授權人不能撤回任何使用者使用本素材的自由。 

### 中文化編修進度表

- AI初翻: 已全部完成。
- 第一次編修: 依各單元完成次單元估計。
- 第二次編修: 歡迎使用者透過各單元網頁右方**編輯本頁面**或**問報問題**的留言連結，協助編修及提出指正。

|單元|AI初翻|第一次編修|第二次編修|
|---|---|---|---|
| @sec-why-do-we-learn-statistics |100%|100%|0%|
| @sec-A-brief-introduction-to-research-design |100%|100%|0%|
| [單元3](03-Getting-started-with-jamovi.html) |100%|100%|0%|
| @sec-Descriptive-statistics|100%|100%|0%|
| @sec-Drawing-graphs|100%|100%|0%|
| @sec-Pragmatic-matters|100%|100%|0%|
| [中場故事](Prelude-Part-IV.html) |100%|100%|0%|
| @sec-Introduction-to-probability|100%|100%|0%|
| @sec-Estimating-unknown-quantities-from-a-sample|100%|100%|0%|
| @sec-Hypothesis-testing|100%|100%|0.5%|
| @sec-Categorical-data-analysis|100%|79%|0%|
| @sec-Comparing-two-means|100%|81%|0%|
| @sec-Correlation-and-linear-regression|100%|37%|0%|
| @sec-Comparing-several-means-one-way-ANOVA|100%|53%|0%|
| @sec-Factorial-ANOVA |100%|0%|0%|
| @sec-Factor-Aanalysis |100%|75%|0%|
| @sec-Bayesian-statistics |100%|0%|0%|
| [後記](Epilogue.html) |100%|5%|0%|


## 英文版版本沿革與版權說明 {.unnumbered}
...
this, I have also been through the rest of the book and tried to separate out some of the algebra by putting it into a box or frame. It’s not that this stuff is not important or useful, but for some students they may wish to skip over it and therefore the boxing of these parts should help some readers.
...
Soft copy:
[www.compcogscisydney.com/learning-statistics-with-r.html](https://www.compcogscisydney.com/learning-statistics-with-r  
Hard copy:

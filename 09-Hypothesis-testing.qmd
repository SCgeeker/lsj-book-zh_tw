...
[^09-hypothesis-testing-2]: 技術性註記。這一章的敘述與許多入門教材的常見說明有些微不同。經典的虛無假設檢定理論是20世紀初期，由Ronald Fisher和Jerzy Neyman發展出來的，但是Fisher和Neyman對於理論的運作有非常不同的看法。現今大多數教材所採用的檢定理論是兩種觀點的混合。這裡所採用的解說較接近Neyman的風格，特別在解釋p值意義的部分。
...
## 統計檢定的p值{#sec-The-p-value-of-a-test}
...
虛無假設檢定是統計理論最普遍的一種應用。大部份科學研究報告都會在結果呈現某種假設的檢定。現代科學研究者幾乎都要多少了解p值的意義，否則不能被認為是合格的科學研究者 ，所以這一章是本書最重要的部分。以下幫助讀者及學生快速回顧本章重點：
...
- [運用樣本分佈檢測統計值](09-Hypothesis-testing.html#%E9%81%8B%E7%94%A8%E6%A8%A3%E6%9C%AC%E5%88%86%E4%BD%88%E6%AA%A2%E6%B8%AC%E7%B5%B1%E8%A8%88%E5%80%BC).
- 統計推論的[決策要素](09-Hypothesis-testing.html#%E7%B5%B1%E8%A8%88%E6%8E%A8%E8%AB%96%E7%9A%84%E6%B1%BA%E7%AD%96%E8%A6%81%E7%B4%A0)
- [統計檢定的p值](http://localhost:7933/09-Hypothesis-testing.html#sec-The-p-value-of-a-test) 為何用p值做決策是"模擬兩可"。
